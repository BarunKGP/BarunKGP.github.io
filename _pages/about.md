...
This summer (2022), I was a software engineering intern at Autodesk, where I designed a knowledge graph based recommendation system, utilizing AWS servuces. I also created a GraphQL API which could be used to query the recommendation system and generate useful pipelines for the end-user. 
Prior to joining Georgia Tech, I worked as a software engineer at General Electric where I was responsible for developing and deploying REST-based microservices in Java. 
I also optimized the DevOps and CI/CD pipelines for the project. 
My work involved updating PDIs and scripts and to migrate build artifacts, Helm charts and images to JFrog Artifactory.
